...
- atributos
- passar um DF
- Matrizes e Arrays no Rcpp armadillo
- interromper loop
- ponteiros externos (apontar p/ uma classe do c++)
- linkar com uma lib externa (poderia ser uma header only qualquer)
- mais alguns casos de uso
- alguns exemplos usando a API do R direto
- um pouquinho sobre cpp 11
