...
- 9h às 13, pausa de 10 min +- 11h
- serão gravadas e disponibilizadas no Classroom
- pode mandar dúvidas no chat ou abrir o microfone para perguntar
- teremos bastante exercícios para resolver durante o workshop

---
## Apresentação

Seria legal se todos se apresentassem:
...
No C++ o constructo if-else é idêntico ao R.
...
É possível chamar funções do R pelo Rcpp. Para isso usamos o tipo Function.
