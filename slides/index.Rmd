...
- [Rcpp book](https://teuder.github.io/rcpp4everyone_en/)
...
- [x] vetores (C)
- [x] in-place operations (D) # Cara, acho que fiz isso sem perceber
- [x] atributos (C)
- [x] passar um DF (D)
- [x] Matrizes e Arrays no Rcpp armadillo (C)
- [x] mais alguns casos de uso (D)
- [x] exercícios (C)
- [ ] exercícios (D)

- [x] interromper loop (C)
- [ ] ponteiros externos (apontar p/ uma classe do c++) (D)

- [ ] alguns exemplos usando a API do R direto (C)
- [ ] um pouquinho sobre cpp 11 (D)
- [ ] Rcpp parallel (C)
